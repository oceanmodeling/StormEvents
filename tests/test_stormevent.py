...
def test_storm_event_lookup():
    ...
    assert repr(florence2018) == "StormEvent(name='FLORENCE', year=2018, start_date=Timestamp('2018-08-30 06:00:00'), end_date=Timestamp('2018-09-18 12:00:00'))"
...
def test_storm_event_coops_product_within_region(florence2018):
    null_track = florence2018.track(
        end_date=florence2018.start_date + timedelta(hours=12))
    null_data = florence2018.coops_product_within_region(
            'water_level', region=box(*null_track.linestring.bounds),
