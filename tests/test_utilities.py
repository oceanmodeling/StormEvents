...
def test_subset_time_interval():
    ...
    interval_2 = subset_time_interval('2020-01-01', '2021-01-01', '2020-02-01',
                                      '2020-11-01')
    ...
    with pytest.raises(ValueError):
        subset_time_interval('2021-01-01', '2020-01-01', '2020-02-01',
                             '2020-11-01')

    with pytest.raises(ValueError):
        subset_time_interval('2020-01-01', '2021-01-01', '2020-11-01',
                             '2020-02-01')
    ...
    with pytest.raises(ValueError):
        subset_time_interval('2020-01-01', numpy.nan, '2020-02-01',
                             '2020-11-01')
...
def test_relative_to_time_interval():
    ...
    time_2 = relative_to_time_interval('2020-01-01', '2021-01-01',
                                       '2020-02-01')
    time_3 = relative_to_time_interval('2020-01-01', '2021-01-01',
                                       timedelta(days=30 * 3))
    time_4 = relative_to_time_interval('2020-01-01', '2021-01-01',
                                       5 * 24 * 60 * 60)
