...
class HighWaterMarksEnvironment(Enum):
    COASTAL = 'Coastal'
    RIVERINE = 'Riverine'
...
class HighWaterMarks:
    ...
    def __init__(
            ...
            environment: HighWaterMarksEnvironment = HighWaterMarksEnvironment.RIVERINE,
...
class HurricaneHighWaterMarks(HighWaterMarks):
    def __init__(
        ...
        super().__init__(environment=environment, still_water=still_water)
